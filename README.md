...
- [Google AI Hackathon Project](#google-ai-hackathon-project)
  - [目次](#目次)
  - [概要](#概要)
  - [技術スタック](#技術スタック)
  - [主要コンポーネント](#主要コンポーネント)
  - [セットアップ](#セットアップ)
    ...
    - [Dockerfile](#dockerfile)
      - [ryeを使用する場合](#ryeを使用する場合)
      - [pipとrequirements.txtを使用する場合](#pipとrequirementstxtを使用する場合)
    - [コンテナ作成](#コンテナ作成)
...
- ナレッジグラフはすでにNeo4jに作成されているので、`make_agent.py`と`app.py`でチャットボットを起動できます
- ナレッジグラフを一から作る場合は`make_graph.py`で作成できます
- ナレッジグラフを作成するためのテキストデータは`get_wiki_articles.py`を実行し、`workspace/input/`配下に入れてください
